...
<table width="531" border="1">
		...
		str2="select c.cid,c.cname,p.pid,p.pname,c1.companyname,c1.cost,c1.avail from producttype c1,category1 c,products p where c.cid="+2+" and c.cid=p.cid and p.pid=c1.pid ";
